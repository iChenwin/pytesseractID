...
def tesseractID(path):
    ...
    #画框
    cv2.drawContours(binaryed, contours, -1, (255,0,0), 3)
    # cv2.imshow("img", binaryed)
    # k = cv2.waitKey(0) 
    ...
    print path + ":______________________"
    IDstring = tesseractImg(reversed(IDimgs))
    # print(path + ": " + IDstring)
